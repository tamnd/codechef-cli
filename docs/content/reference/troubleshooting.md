...
Most of these come down to network reality or how codechef serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

codechef rate-limits like any public site. cc already paces
...
Where a surface is gated, cc reads a cookie or token you supply
...
`cc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cc actually did
